...
>>>>>>> 288ce4d7fa7f96c0671927a2fc85e6387cb8f346


                                <div class="mx-auto w-50 mt-3">
                                    <label for="price_sale">Price_sale</label>
                                    <input type="text" name="price_sale" id="price_sale" class="form-control" value="{{ $product->price_sale }}">
                                </div>
                                ...
                                <div class="mx-auto w-50 mt-3">
                                    ...
                                    <textarea name="describe" id="describe" class="form-control" value="{{ $product->describe }}"></textarea>
                                </div>
